...
#   You are tasked with creating a keyword indexing system for a collection of documents. Each
#   document is represented as a string, and you need to create an index that maps each keyword to
#   the documents in which it appears. Write a Python function to implement this indexing system.
#   our function should take a list of documents as input and return a dictionary where the keys 
#   are keywords and the values are lists of document indices where the keyword appears.
